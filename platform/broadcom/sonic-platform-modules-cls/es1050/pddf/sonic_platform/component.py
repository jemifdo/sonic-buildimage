...
SWCPLD_VERSION_CMD = ['i2cget', '-y', '-f', '1', '0x32', '0']
...
class Component(ComponentBase):
    ...
    def __init__(self, component_index):
        self.component_list = [["BIOS", "Basic Input/Output System", BIOS_VERSION_CMD, self.__get_cmd_output],\
                               ...
                               ["CPLD COMe", "COMe board CPLD", COMe_CPLD_VERSION_CMD, self.__get_cpld_version],\
                               ["CPLD SW", "For managing the chassis and SFP+ ports (49-52)", SWCPLD_VERSION_CMD, self.__get_cpld_version],\
